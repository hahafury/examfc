export default {
  ...
  //-----Events
  CHANGE_EVENTS_MODE_VIEW: 'CHANGE_PROFILE_MODE_VIEW',
  CHANGE_ADD_EVENTS_MODE_ON_EVENTS_PAGE: 'CHANGE_ADD_EVENTS_MODE_ON_EVENTS_PAGE',
  CREATE_EVENT: 'CREATE_EVENT',
  CREATE_EVENT_SUCCESSFUL: 'CREATE_EVENT_SUCCESSFUL',
  CREATE_EVENT_ERROR: 'CREATE_EVENT_ERROR',
  EVENT_CLEAR_ERROR: 'EVENT_CLEAR_ERROR',
  //-----Recovery password
  CHANGE_PASSWORD: 'CHANGE_PASSWORD',
  CHANGE_PASSWORD_REQUEST: 'CHANGE_PASSWORD_REQUEST',
  CHANGE_PASSWORD_SUCCEED: 'CHANGE_PASSWORD_SUCCEED',
  CHANGE_PASSWORD_ERROR: 'CHANGE_PASSWORD_ERROR',
  CHANGE_PASSWORD_ERROR_CLEAR: 'CHANGE_PASSWORD_ERROR_CLEAR',
  RECOVERY_PASSWORD_REQUEST: 'AUTH_ACTION_REQUEST',
  RECOVERY_PASSWORD: 'RECOVERY_PASSWORD',
  RECOVERY_PASSWORD_SEND_BY_MAIL: 'RECOVERY_PASSWORD_SEND_BY_MAIL',
  RECOVERY_PASSWORD_ERROR: 'RECOVERY_PASSWORD_ERROR',
  RECOVERY_PASSWORD_CLEAR: 'RECOVERY_PASSWORD_CLEAR',
  RECOVERY_ACTION_CLEAR: 'RECOVERY_ACTION_CLEAR',
  //-----Moderation contests
  MODERATION_CONTEST_VERDICT: 'MODERATION_CONTEST_VERDICT',
  MODERATION_CONTEST_SUCCEED: 'MODERATION_CONTEST_SUCCEED',
  MODERATION_CONTEST_ERROR: 'MODERATION_CONTEST_ERROR',
  MODERATION_CONTEST_ERROR_CLEAR: 'MODERATION_CONTEST_ERROR_CLEAR',
};
